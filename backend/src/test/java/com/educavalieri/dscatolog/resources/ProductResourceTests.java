...
public class ProductResourceTests {
    ...
    void setup() throws Exception{
        ...
        when(productServiceIMP.findAllPagedWithCategoryId(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(page);
...
//        result.andExpect(status().isOk());
    ...
    @Test
    public void findAllWithCategoryIdShouldReturnPage() throws Exception {
        mockMvc.perform(get("/products/categoryId")).andExpect(status().isOk());
